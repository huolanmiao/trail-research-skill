...
我们作为社区成员、贡献者和管理者，承诺为所有人提供一个无骚扰的参与环境，
无论其年龄、体型、可见或不可见的残疾、民族、性特征、性别认同和表达、经验
水平、教育程度、社会经济地位、国籍、个人外貌、种族、种姓、肤色、宗教信仰
或性取向。
...
be reported to the community leaders by opening a **private security
advisory** on GitHub, or via any channel listed in `SECURITY.md`.
